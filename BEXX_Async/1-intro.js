...
/* ------------------------------------------------*
//* Senkron  // İşlemlerin sırasıyla yapılması
...
alert("Blocked"); //?Blocking kod. Burada alert olduğu için kullanıcıdan bir veri girişi bekliyor. Bu veri girişi olana kadar alttaki console.log'u çalıştırmıyor. Bu nedenle blocking code diyoruz.
...
delay(4000) //? blocking code - senkron //4000 ms geçene kadar hiçbir işlem yapmaz. Devamındaki işlemlerin yapılmasını bloklar.
console.timeEnd("gecikme");
console.log("hi");

/* ------------------------------------------------*
//* Asenkron (setTimeOut(),clearTimeout())  // İşlemler tamamen sırasıyla çalışmaz. Çalıştırılması gereken sırayla çalışır.
// *Asekson'a Örnek
...
/* ------------------------------------------------*
//* iki setTimeout fonk.varsa süresi uzun olan sonra basilir. setTimeOut() ile işlem başlatılır ve setTimeOut'tan sonra gelen kod çalışmaya devam eder. setTimeOut'ta verilen süre dolunca setTimeOut'un içerisindeki kod çalışır.
...
/* ------------------------------------------------*
//* Timeout verilen task kuyruğun en sonuna eklenir. Timeout Değeri 0 bile olsa ayni anda gelen isteklere cevap vermek icin bir sira olmali bankalardaki fis sirasindaki gibi müsterilere sonradan bile geldigi halde öne geciyor disaridaki müsterilere göre
